...
?>
 <li class="clearfix">
   <a class="image" href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail()) { the_post_thumbnail('size1'); }; ?></a>
   <div class="info">
    <?php if( $show_date == '1' ) { ?>
...
<?php
 ...
 function form($instance) {
  $defaults = array( 'title' => __('Pickup post', 'tcd-w'), 'post_num' => '3', 'show_desc' => '1', 'show_date' => '1', 'post_type' => 'normal_post', 'post_order' => 'date1');
