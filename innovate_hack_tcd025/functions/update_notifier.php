	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="http://tcd-wp.net/dl025/innovate/innovate_tcd025.zip">最新版のテーマをダウンロードする</a> 】</p>
          <div id="mono_info">
	   <h3>更新情報</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_innovate.xml';
	
	$db_cache_field = 'cubey-contempo-notifier-cache';
	$db_cache_field_last_updated = 'cubey-contempo-notifier-last-updated';
